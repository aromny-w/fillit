...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2018/11/10 02:34:42 by aezzeddi          #+#    #+#             */
/*   Updated: 2018/11/30 15:54:44 by zcadwyl          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static	int		get_next_word_pos(char const *str, char c, int pos)
{
	while (str[pos] == c)
		pos++;
	return (pos);
